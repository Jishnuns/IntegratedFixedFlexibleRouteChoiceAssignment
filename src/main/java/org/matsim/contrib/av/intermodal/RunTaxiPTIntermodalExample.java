...
//new import for fares 16/7/2018
...
public class RunTaxiPTIntermodalExample {
	...
	public static void main(String[] args) {
		String configFile = "intermodal/Sioux/configSiouxScenario3.xml";
		//String configFile = "resources/intermodal/configSiouxScenario3.xml";
		new RunTaxiPTIntermodalExample().run(configFile,false);
	}

	public void run(String configFile, boolean OTFVis) {
